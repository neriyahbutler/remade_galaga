...
sfx_path_1 = os.path.join(base_path, "../../galaga_sfx/wav/07 Boss Stricken#1.wav")
sfx_path_2 = os.path.join(base_path, "../../galaga_sfx/wav/08 Boss Stricken#2.wav")
sfx_path_3 = os.path.join(base_path, "../../galaga_sfx/wav/10 Tractor Beam Shot.wav")
sfx_path_4 = os.path.join(base_path, "../../galaga_sfx/wav/11 Tractor Beam Capture.wav")
sfx_path_5 = os.path.join(base_path, "../../galaga_sfx/wav/12 Capture Music.wav")

sfx_path_1 = sfx_path_1.replace("\\", "/")
# print("This is a path:", sfx_path_1, type(sfx_path_1))
